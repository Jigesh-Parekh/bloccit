...
RSpec.describe Post, type: :model do
  ...
  describe "voting" do
    ...
    describe "#down_votes" do
      it "counts the number of votes witht the value of -1" do
        expect( post.down_votes).to eq(@down_votes)
      end
    end

    describe "points" do
      it "counts the difference and retuns the sum of up and down votes" do
